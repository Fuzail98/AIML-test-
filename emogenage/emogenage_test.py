...
json_file = open('./Facial-emotion-recognition/top_models/fer.json', 'r')
loaded_model_json = json_file.read()
json_file.close()
model1 = model_from_json(loaded_model_json)
model1.load_weights('./Facial-emotion-recognition/top_models/fer.h5')

model_age = load_model('./Age-Gender-Prediction/model/model_age.hdf5')
# load model
